...
#include "tm5_joy_teleop/moveit_servo.hpp"

Moveit_Servo::Moveit_Servo()
{
  nh_ = std::make_shared<rclcpp::Node>("tpc_servo_node");
  ...
  std::thread(std::bind(&Moveit_Servo::spin, this)).detach();
...
void Moveit_Servo::connect_moveit_servo()
{
  for(int i =0; i <= 10; ++i)
  {
...
void Moveit_Servo::start_moveit_servo()
{
...
void Moveit_Servo::stop_moveit_servo()
{
