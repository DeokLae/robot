...
#include "tm5_joy_teleop/tm5_joy_teleop.hpp"
namespace tpc
{
namespace tm5_joy
{
    ...
    void Tm5JoyTeleop::receive_joy_message(std::unique_ptr<sensor_msgs::msg::Joy> msg)
    {
        ...
        if(has_event)
        {
            ...
            RCLCPP_INFO(this->get_logger(), "=========================================================");*/
            arm_twist_pub_->publish(std::move(arm_twist_message));
        }
    }
    ...
    void Tm5JoyTeleop::declare_parameter_value()
    {
        ...
        btn_X_config_.num = (uint32_t)get_parameter("btn.B_config.num").as_int();
        //Y :: 4
